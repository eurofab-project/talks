...
1. The core functionality for the pipeline was made available within open-source packages - `momepy`, `libpysal`, `sgeop` and the project itself is a public repository.
